...
@interface CreditView : UIView {
	...
	@property (nonatomic, assign) UIImageView * appImage;
	@property (nonatomic, assign) UILabel * nomeAppLabel;
	@property (nonatomic, assign) UILabel * optionsLabel;
	@property (nonatomic, assign) UILabel * sviluppataDaLabel;
	@property (nonatomic, assign) UILabel * versioneAppLabel;
	@property (nonatomic, assign) UILabel * voiceOverLabel;
	@property (nonatomic, assign) UISwitch * voiceOverSwitch;
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
	-(void) xamarinSetGCHandle: (int) gchandle;
