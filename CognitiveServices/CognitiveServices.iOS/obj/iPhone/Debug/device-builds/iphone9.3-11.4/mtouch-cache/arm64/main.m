...
extern void *mono_aot_module_CognitiveServices_iOS_info;
...
extern void *mono_aot_module_CognitiveServices_info;
extern void *mono_aot_module_Xamarin_Forms_Xaml_info;
extern void *mono_aot_module_Microsoft_ProjectOxford_Face_info;
extern void *mono_aot_module_Newtonsoft_Json_info;
extern void *mono_aot_module_Microsoft_ProjectOxford_Common_info;
...
{
	mono_aot_register_module (mono_aot_module_CognitiveServices_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_CognitiveServices_info);
	mono_aot_register_module (mono_aot_module_Xamarin_Forms_Xaml_info);
	mono_aot_register_module (mono_aot_module_Microsoft_ProjectOxford_Face_info);
	mono_aot_register_module (mono_aot_module_Newtonsoft_Json_info);
	mono_aot_register_module (mono_aot_module_Microsoft_ProjectOxford_Common_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "CognitiveServices.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
